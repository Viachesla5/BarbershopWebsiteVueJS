...
<div class="container mx-auto mt-8 flex justify-center">
    <!-- EDIT FORM (Combined) -->
    <form id="profileForm" action="/admin/users/edit/<?= $user['id'] ?>" method="POST" class="w-full max-w-md bg-dark-100 p-6 rounded shadow-lg border border-dark-50">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        profilePicInput.addEventListener('change', function(e) {
            ...
            fetch('/admin/users/uploadPicture/<?= $user['id'] ?>', {
                method: 'POST',
                body: formData
            })
